    ...
    <div className="visual-main-container">
      <div className="ag-timeline-block">
        <div className="ag-timeline_title-box">
          <div className="ag-timeline_tagline">DNS VISUALISER</div>
          <div className="ag-timeline_title">VISER</div>
        </div>
                    ...
                    <div className="ag-timeline-card_inner">
                      ...
                      <div className="ag-timeline-card_info">
                        ...
                        <div className="ag-timeline-card_desc">
                          ...
                          ut libero venenatis faucibus. Nullam quis ante. Etiam
                          sit amet orci eget eros faucibus tincidunt. Duis leo.
